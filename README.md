...
bloqueio agressivo do Akamai em IPs de runner. O workflow atual roda as fontes
mais estáveis: `ous umbro netshoes baw netshoes_baw netshoes_adidas
netshoes_adidas_originals`. Para incluir Centauro/Approve, rode local/VPS (com
proxy no caso da Centauro) ou use o bot on-demand no servidor.
